...
plt_rating_per_sector <- top_jobs %>% 
                         ...
                         geom_dotplot(size=5, binaxis = "y", stackdir = "center", color = "gold", dotsize = 1.5) +
